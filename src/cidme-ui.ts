...
class CidmeUi {
  ...
  constructor () {
     ...
     */
    createBasicEntityCardHtml(entityId:string):string {
        let data = ''

        // Remove hyphens from UUIDs for use with HTML IDs
        let idParts = entityId.split('/')
        let entityIdUuid = ''
        //if (idParts.length === '') {
     ...
     */
    createBasicEntityContextCardHtml(entityContextId:string):string {
        let data = ''

        // Remove hyphens from UUIDs for use with HTML IDs
        let idParts = entityContextId.split('/')
        let entityContextIdUuid = ''
        //if (idParts.length === '') {
